<template>
    <div>
        ...
        <p v-if="showDiscription">
            ...
            Нажав кнопку "параметры", вы можете указать пароль для дешифрования записки, установить срок её действия и настроить уведомление о прочтении, когда записка будет уничтожена.
        </p>
        <MessageForm/>
